(function( $ ){
    ...
    $(function() {	
        ...
        uploader = WebUploader.create({
			...
			//自动上传。
        	auto:true,
            formData:{gid:0,csrfmiddlewaretoken:csrftoken},
            dnd:'#dndArea',
            paste:'#uploader',
            chunked:false,
            chunkSize:512*1024,
            server:up_server,
            runtimeOrder:"html5",
            accept:{title: '文件类型',extensions:'gif,jpg,jpeg,png,webp,zip,rar,7z,gz,tar,mp4,doc,docx,xls,xlsx,ppt,pptx,apk,iso,pdf,ico',mimeTypes: ''},
			compress:false,
			resize:false,
